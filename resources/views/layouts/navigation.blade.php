<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('api-practices')" :active="request()->routeIs('api-practices')">
                        {{ __('Practices API') }}
                    </x-nav-link>
                    <x-nav-link :href="route('employee.index')" :active="request()->routeIs('employee.*')">
                        {{ __('Employees') }}
                    </x-nav-link>
                    <x-nav-link :href="route('field.index')" :active="request()->routeIs('field.*')">
                        {{ __('Fields') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('api-practices')" :active="request()->routeIs('api-practices')">
                {{ __('Practices API') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('employee.index')" :active="request()->routeIs('employee.*')">
                {{ __('Employees') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('field.index')" :active="request()->routeIs('field.*')">
                {{ __('Fields') }}
            </x-responsive-nav-link>
        </div>
