        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg ">
                    <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{ url('employee')}}">
                        @csrf
                        <div class="mt-8 px-4 max-w-md">
                            <div class="grid grid-cols-1 gap-8">
                            <label class="block">
                                <span class="text-gray-700">First Name</span>
                                <input type="text" id="name" name="first_name" class="mt-1 block w-full rounded" required="" value="{{ old('first_name') }}">
                                @error('first_name')
                            ...
                            <label class="block">
                                ...
                                <input type="text" id="name" name="last_name" class="mt-1 block w-full rounded" required="" value="{{ old('last_name') }}">
                                @error('last_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </label>
                            ...
                            <label class="block">
                                ...
                                <input type="text" id="email" name="email" class="mt-1 block w-full rounded" value="{{ old('email') }}"  >
                                @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </label>
                            <label class="block">
                                ...
                                <input type="text" id="phone" name="phone" class="mt-1 block w-full rounded" value="{{ old('phone') }}">
                                @error('phone')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </label>
